...
'I'를 눌러 초기 위치로 이동 후 'Q' 를 눌러 Ego Controller를 AV-ExternalCtrl로 설정한 뒤 코드를 실행해야 동작함.
...
def main():
    ...
    path = pd.read_csv(str(Path(__file__).resolve().parents[2]) + '\\lib\\trajectory\\path.csv')
